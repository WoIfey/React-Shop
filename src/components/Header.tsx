				...
				<div className="flex absolute left-48">
					...
					<div className="flex my-2">
						<input
							type="text"
							placeholder="Search"
							className="h-10 sm:h-12 max-w-[200px] rounded-tl-xl rounded-bl-xl border-4 border-[#A5A5A5] px-4 text-lg outline-none"
						/>
						<Link
							to="/search"
							className="h-10 sm:h-12 w-12 rounded-tr-xl rounded-br-xl border-4 border-l-0 border-[#A5A5A5] hover:bg-[#ebebeb] transition duration-150"
						>
							<img
				...
				{token && (
					<div className="absolute right-48">
						<div className="bg-[#E6E6E6] h-16 rounded-lg flex items-center justify-center px-4">
							...
							<p className="w-32 ml-2 truncate text-base border-l-2 border-[#A6A6A6] pl-5">
								bob@example.com
							</p>
							<button className="cursor-default">
								<img
